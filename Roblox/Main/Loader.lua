...
if _Protected_By_Hawk then
	...
	Solariumhub = Instance.new("Frame")
                   ...
                   Solariumhub.Name = "script"
                    ...
                    UICorner_24.Parent = Execute
					  ...
					  Execute.MouseEnter:Connect(function()
					   ...
					   Execute.MouseButton2Click:Connect(function()
						TweenService:Create(
							  Execute,
							TweenInfo.new(.2, Enum.EasingStyle.Quad),
							{Size = UDim2.new(0, 95,0, 27)}
			   ...
			   Copy.MouseEnter:Connect(function()
					   ...
					   Copy.MouseButton2Click:Connect(function()
						TweenService:Create(
							 Copy,
							TweenInfo.new(.2, Enum.EasingStyle.Quad),
							{Size = UDim2.new(0, 95,0, 27)}
...
TweenService:Create(
              ...
              createscript("Rise","Skywars [CLASSIC]","Made By SHWX Team, HzShadow",Color3.fromRGB(185, 0,0),Color3.fromRGB(80, 0,0),"https://raw.githubusercontent.com/ShadowBey01/Rise/refs/heads/main/Rise","https://dc.gg/shwxteam")
			...
			HawkHUB.TextLabel_9.Text = "Scripters: <font color=\"rgb(186, 186, 188)\">Hanki, Falpearx, Fqrkan and mov</font>"
			...
			HawkHUB.TextLabel_10.Text = "Friends: <font color=\"rgb(186, 186, 188)\">Shadow, trxdent, righthit and forge </font>"
...
local dede =loadstring(game:HttpGet("https://raw.githubusercontent.com/xwerta/HawkHUB/refs/heads/main/Roblox/UILibs/PcLib.lua", true))()

local Notificatin = dede:Notification()
local zoet = HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/xwerta/HawkHUB/refs/heads/main/Roblox/Important/games.json"))
