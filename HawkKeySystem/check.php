...
if(strpos($agent, 'MSIE') !== FALSE || strpos($agent, 'Trident') !== FALSE || strpos($agent, 'Firefox') !== FALSE || strpos($agent, 'Opera Mini') !== FALSE || strpos($agent, 'Opera') !== FALSE || strpos($agent, 'Safari') !== FALSE || strpos($agent, 'Mozilla') !== FALSE) {}
$sub = $_GET["key"];
$hwid = $_GET['hwid'];
...
$devkeys = array(
  "31", //Admin Key
  "MCLovin67" //BrickCrypt's Key 3 weeks
); 
